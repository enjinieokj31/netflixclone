...
function Header(props) {
    ...
    useEffect(()=>{
        if(video){
        dispatch(fetchHeaderDetails({type: streamType, id: video.id}))  // async thunk only accepts one parameter so we are passing object
    }
    },[video])
        ...
        <div className='position-relative vh-100'>
          ...
          <>
           ...
           <div className='caption'>
            ...
            <p className='led'>{truncateText(data?.overview, 180)}</p>
